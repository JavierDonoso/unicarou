...
export class Carousel implements OnDestroy,OnInit {
    @Input('noWrap') public noWrap:boolean;
    @Input('noPause') public noPause:boolean;
    @Input('noTransition') public noTransition:boolean;
 @Input('interval') public get interval():number {
